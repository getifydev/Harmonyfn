...
// Type: Harmony.Backend.Controllers.AccountController
...
using Harmony.Backend.Models.Account;
using Harmony.Backend.Models.Exceptions.OAuth;
using System;
...
namespace Harmony.Backend.Controllers
{
  ...
  public class AccountController : ControllerBase
  {
    ...
    public ActionResult<Rift.Backend.Models.Account.Account> GetAccountLookupById(
      string accountId)
    {
      return (ActionResult<Harmony.Backend.Models.Account.Account>) new Harmony.Backend.Models.Account.Account()
      {
        Id = Program.Id,
        DisplayName = Program.DisplayName
      };
