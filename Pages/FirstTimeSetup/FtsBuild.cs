...
// Type: Harmony.Frontend.Pages.FirstTimeSetup.FtsBuild
...
#nullable enable
namespace Harmony.Frontend.Pages.FirstTimeSetup
{
  public class FtsBuild : ComponentBase
  {
    ...
    private async Task Validate()
    {
      if (!await this._launcherService.RegisterGame(this._gameName, this._gamePath))
        return;
      string str1 = await this._jsRuntime.InvokeAsync<string>("Harmony.fts.steps.finalIn", (object[]) null);
      string str2 = await this._jsRuntime.InvokeAsync<string>("Harmony.fts.steps.finalOut", (object[]) null);
    }
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
      ...
      __builder.AddAttribute(34, "oninput", "Harmony.fts.utils.validateBtn(this, 'fts-build-next', 25, true)");
