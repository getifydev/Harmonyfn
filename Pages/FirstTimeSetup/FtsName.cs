...
// Type: Harmony.Frontend.Pages.FirstTimeSetup.FtsName
...

{
  public class FtsName : ComponentBase
  {
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
      ...
      __builder.AddAttribute(14, "oninput", "Harmony.fts.utils.validateBtn(this, 'fts-name-next', 16)");
      ...
      __builder.AddMarkupContent(21, "<button id=\"fts-name-next\" onclick=\"Harmony.fts.steps.nextStep(this)\">Next</button>\n    ");
      __builder.CloseElement();
