...
// Type: Harmony.Frontend.Pages.FirstTimeSetup.FtsWelcome
  ...
  public class FtsWelcome : ComponentBase
  {
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
      ...
      for (int index = 0; index < 5; ++index)
      {
        ...
        __builder.AddAttribute(9, "src", "img/fts/Harmony" + index.ToString() + "@.png");
        __builder.AddAttribute(10, "alt", "Harmony " + index.ToString());
