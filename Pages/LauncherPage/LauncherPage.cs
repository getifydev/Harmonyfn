...
// Type: Harmony.Frontend.Pages.LauncherPage.LauncherPage
...
using Harmony.Frontend.Pages.LauncherPage.Tabs;
...
namespace Harmony.Frontend.Pages.LauncherPage
{
  public class LauncherPage : ComponentBase
  {
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
      ...
      __builder.OpenComponent<Harmony.Frontend.Pages.LauncherPage.Tabs.ModsTab.ModsTab>(9);
      __builder.CloseComponent();
