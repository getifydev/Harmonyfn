...
// Type: Harmony.Frontend.Pages.LauncherPage.ChangelogModal
...
namespace Harmony.Frontend.Pages.LauncherPage
{
  ...
  {
    public static string ChangelogTitle = "What's new in Harmony {0}";
    ...
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
      ...
      __builder.AddMarkupContent(8, "<div class=\"close-button\" onclick=\"Harmony.modalManager.hideModal('changelog')\">\n            <i class=\"fas fa-times\"></i>\n        </div>\n        ");
      ...
      __builder.AddAttribute<MouseEventArgs>(55, "onclick", EventCallback.Factory.Create<MouseEventArgs>((object) this, (Action) (() => WindowsUtilities.OpenURL(""))));
