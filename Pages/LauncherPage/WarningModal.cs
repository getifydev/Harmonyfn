...
// Type: Harmony.Frontend.Pages.LauncherPage.WarningModal
...
namespace Harmony.Frontend.Pages.LauncherPage
{
  public class WarningModal : ComponentBase
  {
    ...
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
      ...
      __builder.AddMarkupContent(8, "<div class=\"close-button\" onclick=\"Harmony.modalManager.hideModal('emergency')\">\n\t\t\t<i class=\"fas fa-times\"></i>\n\t\t</div>\n\t\t");
      ...
      __builder.AddAttribute(22, "onclick", "Harmony.modalManager.hideModal('emergency')");
