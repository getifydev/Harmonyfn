...
// Type: Harmony.Frontend.Pages.LauncherPage.Sidebar
...
namespace Harmony.Frontend.Pages.LauncherPage
{
  public class Sidebar : ComponentBase
  {
    ...
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
      ...
      __builder.AddMarkupContent(3, "<div class=\"Harmony-header\">\n        <img src=\"/img/Harmony.png\" alt=\"Icon\">\n        <h1>Harmony</h1>\n    </div>\n    ");
      __builder.OpenElement(4, "li");
      __builder.AddAttribute(5, "id", "play-li");
      __builder.AddAttribute(6, "class", "selected");
      __builder.AddAttribute(7, "onclick", "Harmony.tabManager.setTab('play')");
      ...
      __builder.AddAttribute(14, "onclick", "Harmony.tabManager.setTab('settings')");
      ...
      if (Sidebar.ModsTabEnabled)
      {
        ...
        __builder.AddAttribute(22, "onclick", "Harmony.tabManager.setTab('mods'); Harmony.modsLanding.animations.intro()");
      ...
      __builder.AddAttribute(30, "onclick", "Harmony.tabManager.setTab('info')");
      ...
      if (EmergencyNotice.Enabled)
      {
        ...
        __builder.AddAttribute(39, "onclick", "Harmony.modalManager.showModal('emergency')");
