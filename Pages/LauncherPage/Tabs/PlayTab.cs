...
// Type: Harmony.Frontend.Pages.LauncherPage.Tabs.PlayTab
...
namespace Harmony.Frontend.Pages.LauncherPage.Tabs
{
  public class PlayTab : ComponentBase
  {
    ...
    public static bool HarmonyMultiplayerEvent = false;
    public static string UpdateBackgroundUrl = "/img/chapter2.jpg";
    public static string UpdateHeaderText = "Harmony {0}";
    ...
    private async Task ShowRenameWindow()
    {
      ...
      string str1 = await this._jsRuntime.InvokeAsync<string>("Harmony.contextMenu.hide", (object[]) null);
      string str2 = await this._jsRuntime.InvokeAsync<string>("Harmony.modalManager.showModal", (object) "rename");
    }

    private async Task ApplyRename()
    {
      string str = await this._jsRuntime.InvokeAsync<string>("Harmony.modalManager.hideModal", (object) "rename");
